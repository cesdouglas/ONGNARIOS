		...
		<div class="row">
			...
			<section class="6u 12u$(narrower) 12u$(mobilep)">
				<div class="box highlight">
					...
					<p>
						Cadastre-se! <br> Ajude a sua comunidade a crescer e se
						tornar um lugar melhor.<br> Juntos podemos mais!
					</p>
				</div>
			</section>
			<div id="buttons">
					...
					<div class="row 50%">
						...
						<div class="6u 12u(mobilep)">
							<input type="password" name="senha" id="senha"
								placeholder="Senha" maxlength="12" required="required" />
						</div>
			...
			<section class="6u 12u(narrower)" id="usuario" style="display: none;">
				...
				<a href="javascript:;" id="voltar2"
					style="font-size: 12px; margin-left: 10px;">Escolher de novo?</a>
			</section>
